...
connect_str = 'host=demo-postgres.cxauxtdppqiu.us-east-1.rds.amazonaws.com port=5432 dbname=postgres user=postgres password=secret'  # AWS RDS Public
# connect_str = 'host=rds-share-db-demo.cxauxtdppqiu.us-east-1.rds.amazonaws.com port=5432 dbname=postgres user=postgres password=secret'  # AWS RDS Private
